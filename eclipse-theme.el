  ...
  (apply 'custom-theme-set-faces 'eclipse
         (mapcar
          ...
          `((default :family "DejaVu Sans Mono"
            ...
            (swiper-minibuffer-match-face-1 :background "#dddddd")
            (swiper-minibuffer-match-face-2 :background "#bbbbbb" :weight bold)
            (swiper-minibuffer-match-face-3 :background "#bbbbff" :weight bold)
            (swiper-minibuffer-match-face-4 :background "#ffbbff" :weight bold)
